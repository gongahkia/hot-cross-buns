    ...
    if (request.method !== "POST") {
      return this.finish(
        ...
        McpHttpResponse.plain(
          405,
          "MCP Streamable HTTP GET/SSE is not implemented in Hot Cross Buns v1."
        ),
        "rejected"
      );
    }
