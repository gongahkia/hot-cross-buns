...
Current brand assets live under `assets/brand/`. The macOS package icon is generated from `assets/brand/app-icon.png`; the Qt sidebar and menu-bar item use the corresponding native assets.
