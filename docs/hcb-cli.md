...
`themes list` returns HCB's 100 bundled Ghostty-derived presets in rank order.
...
`themes 20` applies Rose Pine. `themes apply --file PATH` accepts a strict standalone
