...
| Notion Calendar | Keyboard commands and compact next-up surfaces improve orientation. | `week-view-collapsed.png`, `menu-bar-collapsed.png`, `menu-bar-expanded.png` | HCB has command palette actions and native tray/menu-bar scaffolding. | Extend command tests and consider a compact next-up summary in Today/Calendar support panels. Treat native menu-bar UI as separate native parity work. |
