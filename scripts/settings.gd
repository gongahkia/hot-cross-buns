...
const ACTIONS := ["move_forward", "move_back", "move_left", "move_right", "jump", "slam", "dash", "sprint", "slide", "grapple", "glide", "consume_food", "collect_water", "purify_water", "consume_water", "place_material", "build_shelter", "reset_run", "pause"]
