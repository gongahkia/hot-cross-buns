...
func _initialize() -> void:
	...
	print("PHOTO_SIDECAR=" + JSON.stringify(sidecar))
	print("PHOTO_EMBEDDED=" + JSON.stringify(embedded_sidecar))
	print("PHOTO_VALIDATION=" + JSON.stringify(SCHEMA.validate(embedded_sidecar)))
