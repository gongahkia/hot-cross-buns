...
const RECORDS := {
	...
	"territorial_boar":{"id":"territorial_boar","name":"Territorial boar","families":["wilderness","overgrown_suburb"],"mobility":"ground","awareness_range":20.0,"flee_distance":32.0,"territorial":true}
}
