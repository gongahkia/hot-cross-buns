...
func _initialize() -> void:
	...
	assert(InputMap.has_action("collect_water") and InputMap.has_action("purify_water") and InputMap.has_action("consume_water") and InputMap.has_action("place_material"), "survival inputs missing")
