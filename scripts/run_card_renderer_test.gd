...
func _initialize() -> void:
	var card := RENDERER.render({"world":{"seed":"7","generator_schema_version":"2.0.0"},"run":{"id":2,"outcome":"extracted","level":"<expedition>","elapsed":125.0,"collectibles":3,"resources":{"wood":2,"food":1},"regions":["1:2"]}})
