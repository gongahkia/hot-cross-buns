  ...
  settings: {
    ...
    update: vi.fn(async (request) =>
      ok({
        ...
        hcbHosterLastPackageSha256: request.hcbHosterLastPackageSha256 ?? null,
        ...
        localHostersEnabled: request.localHostersEnabled ?? false,
        localHosterPort: request.localHosterPort ?? 0,
